...
#            theta4 = angle_adj(atan2(R3_6[2,2], -R3_6[0,2]))
#            theta5 = angle_adj(atan2(sqrt(R3_6[0,2]*R3_6[0,2] + R3_6[2,2]*R3_6[2,2]),R3_6[1,2]))
#            theta6 = angle_adj(atan2(-R3_6[1,1],R3_6[1,0]))
...
#            theta5 = atan2(sqrt(R3_6[0,2]*R3_6[0,2] + R3_6[2,2]*R3_6[2,2]),R3_6[1,2])
#            theta6 = atan2(-R3_6[1,1],R3_6[1,0])
	    print(theta1*r2d, theta2*r2d, theta3*r2d, theta4*r2d, theta5*r2d, theta6*r2d)
	    print("")
